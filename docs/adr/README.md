...
| [0015](0015-preserve-native-money-and-derive-reporting-currency.md) | Preserve native money and derive reporting-currency values | Proposed | - | - | - | - | Pryvance will preserve every native Money observation and derive reporting-currency values separately.… |
<!-- adr-index:end -->
